...
import (
	...
	"github.com/polite007/Milkyway/pkg/neutron/commons/dsl/deserialization"
...
func init() {
	...
	MustAddFunction(NewWithPositionalArgs("reverse", 1, false, func(args ...interface{}) (interface{}, error) {
		return Reverse(toString(args[0])), nil
	}))
	...
	MustAddFunction(NewWithSingleSignature("rand_char",
		...
		func(args ...interface{}) (interface{}, error) {
			...
			rint := rand2.Intn(len(charSet))
			return string(charSet[rint]), nil
		}))
